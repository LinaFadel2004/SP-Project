...
namespace GUI {
	...
	/// </summary>
	public ref class teacher_profile : public System::Windows::Forms::Form
	{
	public:
		Form^ teach_profile;

		teacher_profile(void)
		{
			InitializeComponent();
			//
		...
		teacher_profile(Form^ profile)
		{
			InitializeComponent();
			profile = teach_profile;

		}

		teacher_profile(String^ teach_name, String^ password)
		{
			InitializeComponent();
			teacher_name->Text = teach_name;
			pass->Text = password;
		}
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(teacher_profile::typeid));
			...
			this->teacher_name->Text = L"Gehad";
			// 
			// pictureBox1
			// 
